...
V12: Fixed month navigation. Previous/Next now move one month at a time, Current always jumps back to the present, and a month dropdown allows direct switching. Budget amounts save to the selected month; saving the current month's budget also becomes the default for future months. Fixed the date/reset bug that could stop the Current button and month navigation from working.
